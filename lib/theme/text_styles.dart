...
abstract class BalunTextStyles {
  ...
  static const matchInfoSectionBottomText = TextStyle(
    fontFamily: 'Lufga',
    fontSize: 16,
    fontWeight: FontWeight.w400,
  );
  ...
  static const teamCoachCareerTitle = TextStyle(
    fontFamily: 'Lufga',
    fontSize: 14,
    fontWeight: FontWeight.w600,
  );

  static const teamCoachCareerValue = TextStyle(
    fontFamily: 'Lufga',
    fontSize: 18,
    fontWeight: FontWeight.w400,
  );
  ...
  static const aboutAppName = TextStyle(
    fontSize: 22,
    fontWeight: FontWeight.w700,
    fontFamily: 'Lufga',
    height: 1.2,
  ...
  static const aboutAppVersion = TextStyle(
    fontSize: 18,
    fontWeight: FontWeight.w500,
    fontFamily: 'Lufga',
    height: 1,
...
class BalunTextThemesExtension extends ThemeExtension<BalunTextThemesExtension> {
  ...
  final TextStyle matchInfoSectionBottomText;
  ...
  const BalunTextThemesExtension({
    ...
    required this.matchInfoSectionBottomText,
  ...
  ThemeExtension<BalunTextThemesExtension> copyWith({
    ...
    TextStyle? matchInfoSectionBottomText,
    ...
    matchInfoSectionBottomText: matchInfoSectionBottomText ?? this.matchInfoSectionBottomText,
  ...
  ThemeExtension<BalunTextThemesExtension> lerp(
    ...
    return BalunTextThemesExtension(
      ...
      matchInfoSectionBottomText: TextStyle.lerp(matchInfoSectionBottomText, other.matchInfoSectionBottomText, t)!,
