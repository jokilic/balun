...
class BalunTheme {
  ...
  static final lightAppColors = BalunColorsExtension(
    ...
    datePickerInactiveBackground: BalunColors.darkGreen.withValues(alpha: 0.5),
    datePickerActiveIconColor: BalunColors.white,
    datePickerInactiveIconColor: BalunColors.darkGreen.withValues(alpha: 0.5),
  ...
  static final darkAppColors = BalunColorsExtension(
    ...
    navigationBarBackground: BalunColors.dark.withValues(alpha: 0.3),
    navigationBarItemBackground: BalunColors.dark,
    navigationBarItemSelectedBackground: BalunColors.lightDark,
    navigationBarIconColor: BalunColors.white,
    datePickerActiveBackground: BalunColors.dark,
    datePickerInactiveBackground: BalunColors.dark.withValues(alpha: 0.3),
    datePickerActiveIconColor: BalunColors.white,
    datePickerInactiveIconColor: BalunColors.white.withValues(alpha: 0.3),
    slidingInfoPanelBackground: BalunColors.grey,
    info: BalunColors.blue,
    warning: BalunColors.yellow,
    alert: BalunColors.orange,
  );
