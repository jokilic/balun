...
class BalunTheme {
  ...
  static final darkAppColors = BalunColorsExtension(
    ...
    danger: BalunColors.red,
    accentStrong: BalunColors.darkGreen,
    navigationBarBackground: BalunColors.white,
    navigationBarItemBackground: BalunColors.black,
    navigationBarItemSelectedBackground: BalunColors.darkGreen,
    navigationBarIconColor: BalunColors.grey,
    datePickerActiveBackground: BalunColors.grey,
    datePickerInactiveBackground: BalunColors.darkGreen.withValues(alpha: 0.5),
    datePickerActiveIconColor: BalunColors.grey,
    datePickerInactiveIconColor: BalunColors.darkGreen.withValues(alpha: 0.5),
