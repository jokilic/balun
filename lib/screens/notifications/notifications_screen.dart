              ...
              Expanded(
                child: Animate(
                  ...
                  child: NotificationsContent(
                    ...
                    onPressedTriggerMatchStart: getIt.get<NotificationsController>(instanceName: 'notifications').onPressedTriggerMatchStart,
                    onPressedTriggerGoal: getIt.get<NotificationsController>(instanceName: 'notifications').onPressedTriggerGoal,
                    onPressedTriggerMatchProgress: getIt.get<NotificationsController>(instanceName: 'notifications').onPressedTriggerMatchProgress,
                    onPressedTriggerFullTime: getIt.get<NotificationsController>(instanceName: 'notifications').onPressedTriggerFullTime,
