...
class LeagueTopRedCardsController extends ValueNotifier<BalunState<List<PlayerResponse>>> {
  ...
  Future<void> getTopRedCards({
    ...
    final response = await api.getTopRedCards(
      leagueId: leagueId!,
      season: season!,
    );
