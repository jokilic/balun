      ...
      SizedBox(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (_, index) => Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(100),
              color: index == 1 ? context.colors.primaryForeground : context.colors.primaryForeground.withValues(alpha: 0.075),
            ),
            child: Container(
              height: 24,
              ...
              decoration: BoxDecoration(
                ...
                color: index == 1 ? context.colors.primaryBackground.withValues(alpha: 0.8) : context.colors.primaryForeground.withValues(alpha: 0.25),
              ),
            ),
          ),
