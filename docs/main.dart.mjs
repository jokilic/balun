...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1286: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1286(f,arguments.length,x0,x1,x2) }),
      ...
      _1357: () => globalThis.removeSplashFromWeb(),
      _1358: Date.now,
      ...
      _1488: (x0,x1,x2) => x0.transaction(x1,x2),
      _1489: (x0,x1) => x0.objectStore(x1),
      _1490: (x0,x1) => x0.getAllKeys(x1),
      _1491: (x0,x1) => x0.getAll(x1),
      _1493: (x0,x1) => x0.delete(x1),
      _1494: (x0,x1,x2) => x0.put(x1,x2),
      _1495: x0 => x0.clear(),
      _1496: x0 => x0.close(),
      _1498: (x0,x1,x2) => x0.open(x1,x2),
      _1499: (x0,x1) => x0.contains(x1),
      _1502: (x0,x1) => x0.createObjectStore(x1),
      ...
      _1513: (x0,x1,x2) => x0.open(x1,x2),
      _1514: x0 => x0.abort(),
      _1515: (x0,x1) => x0.send(x1),
      _1516: x0 => x0.getAllResponseHeaders(),
      _1517: () => new AbortController(),
      _1518: x0 => x0.abort(),
      _1519: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1520: (x0,x1) => globalThis.fetch(x0,x1),
      _1521: (x0,x1) => x0.get(x1),
      _1522: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1522(f,arguments.length,x0,x1,x2) }),
      _1523: (x0,x1) => x0.forEach(x1),
      _1524: x0 => x0.getReader(),
      _1525: x0 => x0.read(),
      _1526: x0 => x0.cancel(),
      ...
      _1529: x0 => x0.openCursor(),
      _1530: x0 => x0.continue(),
      ...
      _1551: () => globalThis.window.flutter_inappwebview,
      _1555: (x0,x1) => { x0.nativeCommunication = x1 },
      ...
      _1626: (o, p, v) => o[p] = v,
      _1628: x0 => x0.random(),
      _1629: (x0,x1) => x0.getRandomValues(x1),
      _1630: () => globalThis.crypto,
      ...
      _1661: x0 => x0.naturalWidth,
      _1662: x0 => x0.naturalHeight,
      _1678: x0 => x0.status,
      _1679: (x0,x1) => { x0.responseType = x1 },
      _1681: x0 => x0.response,
      _1718: x0 => x0.readyState,
      _1720: (x0,x1) => { x0.timeout = x1 },
      _1722: (x0,x1) => { x0.withCredentials = x1 },
      _1723: x0 => x0.upload,
      _1724: x0 => x0.responseURL,
      _1725: x0 => x0.status,
      _1726: x0 => x0.statusText,
      ...
      _1742: x0 => x0.total,
      _1805: x0 => x0.style,
      _2236: (x0,x1) => { x0.src = x1 },
      _2251: x0 => x0.naturalWidth,
      _2252: x0 => x0.naturalHeight,
      _2280: x0 => x0.src,
      _2281: (x0,x1) => { x0.src = x1 },
      _2284: x0 => x0.name,
      _2285: (x0,x1) => { x0.name = x1 },
      _2286: x0 => x0.sandbox,
      _2287: x0 => x0.allow,
      _2288: (x0,x1) => { x0.allow = x1 },
      _2289: x0 => x0.allowFullscreen,
      _2290: (x0,x1) => { x0.allowFullscreen = x1 },
      _2295: x0 => x0.referrerPolicy,
      _2296: (x0,x1) => { x0.referrerPolicy = x1 },
      _2376: x0 => x0.videoWidth,
      _2377: x0 => x0.videoHeight,
      _2381: (x0,x1) => { x0.playsInline = x1 },
      _2406: x0 => x0.error,
      _2407: x0 => x0.src,
      _2408: (x0,x1) => { x0.src = x1 },
      _2416: (x0,x1) => { x0.preload = x1 },
      _2417: x0 => x0.buffered,
      _2420: x0 => x0.currentTime,
      _2421: (x0,x1) => { x0.currentTime = x1 },
      _2422: x0 => x0.duration,
      _2427: (x0,x1) => { x0.playbackRate = x1 },
      _2434: (x0,x1) => { x0.autoplay = x1 },
      _2436: (x0,x1) => { x0.loop = x1 },
      _2438: (x0,x1) => { x0.controls = x1 },
      _2440: (x0,x1) => { x0.volume = x1 },
      _2442: (x0,x1) => { x0.muted = x1 },
      _2457: x0 => x0.code,
      _2458: x0 => x0.message,
      _2531: x0 => x0.length,
      _3504: () => globalThis.window,
      _3543: x0 => x0.self,
      _3544: x0 => x0.document,
      _3566: x0 => x0.navigator,
      _3823: x0 => x0.indexedDB,
      ...
      _8645: x0 => x0.url,
      _8647: x0 => x0.status,
      _8649: x0 => x0.statusText,
      _8650: x0 => x0.headers,
      _8651: x0 => x0.body,
      _10107: x0 => x0.result,
      _10108: x0 => x0.error,
      _10113: (x0,x1) => { x0.onsuccess = x1 },
      _10115: (x0,x1) => { x0.onerror = x1 },
      _10119: (x0,x1) => { x0.onupgradeneeded = x1 },
      _10137: x0 => x0.version,
      _10138: x0 => x0.objectStoreNames,
      _10205: x0 => x0.key,
      _10208: x0 => x0.value,
      _10768: (x0,x1) => { x0.border = x1 },
      _11046: (x0,x1) => { x0.display = x1 },
      _11210: (x0,x1) => { x0.height = x1 },
      _11900: (x0,x1) => { x0.width = x1 },
      _12268: x0 => x0.name,
      _12269: x0 => x0.message,
      _13015: () => globalThis.window.flutterCanvasKit,
      _13016: () => globalThis.window._flutter_skwasmInstance,
