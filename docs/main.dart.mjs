...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1649: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1669: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1670: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1670(f,arguments.length,x0) }),
      _1671: x0 => x0.send(),
      _1672: () => new XMLHttpRequest(),
      _1673: (x0,x1) => x0.createElement(x1),
      _1687: () => globalThis.Sentry.close(),
      _1697: () => globalThis.globalThis,
      _1699: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1700: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1701: (x0,x1) => x0.createElement(x1),
      _1715: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1733: (x0,x1) => x0.getItem(x1),
      _1735: (x0,x1,x2) => x0.setItem(x1,x2),
      _1739: () => globalThis.removeSplashFromWeb(),
      _1750: x0 => new Array(x0),
      _1752: x0 => x0.length,
      _1754: (x0,x1) => x0[x1],
      _1755: (x0,x1,x2) => x0[x1] = x2,
      _1756: x0 => new Promise(x0),
      _1758: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1760: x0 => new Int8Array(x0),
      _1761: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1762: x0 => new Uint8Array(x0),
      _1768: x0 => new Uint16Array(x0),
      _1770: x0 => new Int32Array(x0),
      _1772: x0 => new Uint32Array(x0),
      _1774: x0 => new Float32Array(x0),
      _1776: x0 => new Float64Array(x0),
      _1777: (o, t) => typeof o === t,
      _1778: (o, c) => o instanceof c,
      _1781: (o,s,v) => o[s] = v,
      ...
      _1807: () => Symbol("jsBoxedDartObjectProperty"),
      _1808: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1809: () => new TextDecoder("utf-8", {fatal: true}),
      _1810: () => new TextDecoder("utf-8", {fatal: false}),
      _1811: x0 => new WeakRef(x0),
      _1812: x0 => x0.deref(),
      _1818: Date.now,
      _1819: secondsSinceEpoch => {
      ...
      _1820: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1821: s => {
      ...
      _1823: () => typeof dartUseDateNowForTicks !== "undefined",
      _1824: () => 1000 * performance.now(),
      _1825: () => Date.now(),
      _1826: () => {
      ...
      _1828: () => new WeakMap(),
      _1829: (map, o) => map.get(o),
      _1830: (map, o, v) => map.set(o, v),
      _1831: () => globalThis.WeakRef,
      _1842: s => JSON.stringify(s),
      _1843: s => printToConsole(s),
      _1844: a => a.join(''),
      _1845: (o, a, b) => o.replace(a, b),
      _1846: (o, p, r) => o.split(p).join(r),
      _1847: (s, t) => s.split(t),
      _1848: s => s.toLowerCase(),
      _1849: s => s.toUpperCase(),
      _1850: s => s.trim(),
      _1851: s => s.trimLeft(),
      _1852: s => s.trimRight(),
      _1853: (s, n) => s.repeat(n),
      _1854: (s, p, i) => s.indexOf(p, i),
      _1855: (s, p, i) => s.lastIndexOf(p, i),
      _1856: (s) => s.replace(/\$/g, "$$$$"),
      _1857: Object.is,
      _1858: s => s.toUpperCase(),
      _1859: s => s.toLowerCase(),
      _1860: (a, i) => a.push(i),
      _1864: a => a.pop(),
      _1865: (a, i) => a.splice(i, 1),
      _1867: (a, s) => a.join(s),
      _1868: (a, s, e) => a.slice(s, e),
      _1870: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1871: a => a.length,
      _1872: (a, l) => a.length = l,
      _1873: (a, i) => a[i],
      _1874: (a, i, v) => a[i] = v,
      ...
      _1877: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1878: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1879: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1880: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1881: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1882: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1883: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1885: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1886: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1887: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1888: (t, s) => t.set(s),
      _1889: l => new DataView(new ArrayBuffer(l)),
      ...
      _1929: () => new XMLHttpRequest(),
      _1930: (x0,x1,x2) => x0.open(x1,x2),
      ...
      _1954: (x0,x1) => x0.getAllKeys(x1),
      _1955: (x0,x1) => x0.getAll(x1),
      _1957: (x0,x1) => x0.delete(x1),
      _1958: (x0,x1,x2) => x0.put(x1,x2),
      _1959: x0 => x0.clear(),
      _1960: x0 => x0.close(),
      _1962: (x0,x1,x2) => x0.open(x1,x2),
      _1967: (x0,x1) => x0.contains(x1),
      ...
      _1970: (x0,x1) => x0.contains(x1),
      _1971: (x0,x1) => x0.contains(x1),
      ...
      _2004: (x0,x1,x2) => x0.fetch(x1,x2),
      _2005: (x0,x1) => x0.get(x1),
      _2006: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2006(f,arguments.length,x0,x1,x2) }),
      _2007: (x0,x1) => x0.forEach(x1),
      _2008: x0 => x0.abort(),
      _2009: () => new AbortController(),
      _2010: x0 => x0.getReader(),
      _2011: x0 => x0.read(),
      _2012: x0 => x0.cancel(),
      ...
      _2016: x0 => x0.openCursor(),
      _2017: x0 => x0.continue(),
      ...
      _2020: () => new XMLHttpRequest(),
      _2022: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _2299: x0 => x0.readyState,
      _2301: (x0,x1) => x0.timeout = x1,
      _2303: (x0,x1) => x0.withCredentials = x1,
      _2304: x0 => x0.upload,
      _2305: x0 => x0.responseURL,
      _2306: x0 => x0.status,
      _2307: x0 => x0.statusText,
      _2309: (x0,x1) => x0.responseType = x1,
      _2310: x0 => x0.response,
      _2311: x0 => x0.responseText,
      _2324: x0 => x0.loaded,
      _2325: x0 => x0.total,
      _2390: x0 => x0.style,
      _2867: x0 => x0.src,
      _2868: (x0,x1) => x0.src = x1,
      _2871: x0 => x0.name,
      _2872: (x0,x1) => x0.name = x1,
      _2873: x0 => x0.sandbox,
      _2874: x0 => x0.allow,
      _2875: (x0,x1) => x0.allow = x1,
      _2876: x0 => x0.allowFullscreen,
      _2877: (x0,x1) => x0.allowFullscreen = x1,
      _2882: x0 => x0.referrerPolicy,
      _2883: (x0,x1) => x0.referrerPolicy = x1,
      _4122: () => globalThis.window,
      _4163: x0 => x0.self,
      _4164: x0 => x0.document,
      _4167: x0 => x0.location,
      _4186: x0 => x0.navigator,
      _4190: x0 => x0.screen,
      _4202: x0 => x0.devicePixelRatio,
      _4443: x0 => x0.indexedDB,
      _4450: x0 => x0.localStorage,
      _4460: x0 => x0.origin,
      _4469: x0 => x0.pathname,
      _4570: x0 => x0.deviceMemory,
      _4574: x0 => x0.platform,
      _4577: x0 => x0.userAgent,
      _4583: x0 => x0.onLine,
      _4797: x0 => x0.length,
      _6782: x0 => x0.target,
      _6824: x0 => x0.signal,
      _6834: x0 => x0.length,
      _6886: x0 => x0.baseURI,
      _6903: () => globalThis.document,
      _6996: x0 => x0.body,
      _7346: x0 => x0.id,
      _7347: (x0,x1) => x0.id = x1,
      _7591: x0 => x0.length,
      _8728: x0 => x0.value,
      _8730: x0 => x0.done,
      _9453: x0 => x0.url,
      ...
      _9737: x0 => x0.type,
      _9752: x0 => x0.matches,
      _9763: x0 => x0.availWidth,
      _9764: x0 => x0.availHeight,
      _9769: x0 => x0.orientation,
      _10932: x0 => x0.result,
      _10933: x0 => x0.error,
      _10938: (x0,x1) => x0.onsuccess = x1,
      _10940: (x0,x1) => x0.onerror = x1,
      _10944: (x0,x1) => x0.onupgradeneeded = x1,
      _10965: x0 => x0.version,
      _10966: x0 => x0.objectStoreNames,
      _11038: x0 => x0.key,
      _11041: x0 => x0.value,
      _11612: (x0,x1) => x0.border = x1,
      _11890: (x0,x1) => x0.display = x1,
      _12054: (x0,x1) => x0.height = x1,
      _12744: (x0,x1) => x0.width = x1,
      _13875: () => globalThis.window.flutterCanvasKit,
      _13879: () => globalThis.window.flutterCanvasKit,
      _13880: () => globalThis.window._flutter_skwasmInstance,
